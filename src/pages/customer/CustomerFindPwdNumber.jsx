...
import {
  VerifyCustomerPhonePwd,
  VerifyCustomerPhonePwdCheck,
...
export const CustomerFindPwdNumber = () => {
  ...
  const onSubmit = async () => {
    ...
    const conn = async () => {
      const response = await VerifyCustomerPhonePwdCheck(FindPwdbyNumberInput);
    ...
    <Background>
      <Container>
        <LoginRole>
          ...
          <LoginChefes onClick={() => navigate("/findPwdNumberChef")}>
            요리사
          </LoginChefes>
        </LoginRole>
        <TitleBox>
