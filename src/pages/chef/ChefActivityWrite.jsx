            ...
            <TableRow>
              ...
              <TableCell>
                    <UploadButtonContainer>
                      ...
                      <UploadDesc>고객님들에게 보여질 사진을 최대 10장 업로드할 수 있습니다.</UploadDesc>
                    </UploadButtonContainer>
              </TableCell>
            </TableRow>
            <TableRow>
              ...
              <TableCell>
                    <UploadButtonContainer>
                      <InfoValueButton>사진 업로드{'('}최대 10MB{')'}</InfoValueButton>
                      <UploadDescContainer>
                        <UploadDesc>증명서(필수) : 신분증(주민등록증, 운전면허증, 여권) ⚠️사진과 주민등록번호가 보이는 신분증만 인증</UploadDesc>
                        <UploadDesc>증명서(선택) : 재적증명서, 졸업증명서, 경력확인서, 자격증 등</UploadDesc>
                      </UploadDescContainer>
                    </UploadButtonContainer>
              </TableCell>
            </TableRow>
