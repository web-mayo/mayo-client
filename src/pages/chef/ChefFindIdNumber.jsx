...
export const ChefFindIdNumber = () => {
  ...
  return (
    <Background>
      <Container>
        <LoginRole>
          <LoginCustomers onClick={() => navigate("/FindIdNumberCustomer")}>
            고객
          </LoginCustomers>
          ...
          <InputBox>
            ...
            <CertificationBox>
              ...
              <CertButton
                onClick={() => {
                  if (getValues("phone")) {
                    VerifyChefPhoneUsername(getValues("phone"));
                  } else {
                    alert("전화번호를 적어주세요");
                  }
                }}
        ...
        <ChefLoginRouteBox>
          <RouteText onClick={() => navigate("/FindIdEmailChef")}>
            이메일 주소로 아이디 찾기
          </RouteText>
          {/* <RoleChangeText onClick={() => navigate("/FindIdNumberCustomer")}>
            혹시 고객님 이신가요?
          </RoleChangeText> */}
        </ChefLoginRouteBox>
      </Container>
